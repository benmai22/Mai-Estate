    ...
    return (
      ...
      >
        ...
        <a href="#" className="headerUser dropdown-toggle" data-toggle="dropdown">
          <img className="avatar headerAvatar pull-left" src="https://drive.google.com/file/d/1I68Hn3DtMYQb3pPfi139ZCZzD30jWf12/view?usp=sharing" />
          <div className="userTop pull-left">
            <span className="headerUserName">Benjamin Mai</span>
        ...
        <div className="dropdown-menu pull-right userMenu" role="menu">
          <div className="mobAvatar">
            <img
              ...
              src="https://drive.google.com/file/d/1I68Hn3DtMYQb3pPfi139ZCZzD30jWf12/view?usp=sharing"
              alt="avatar"
            />
            <div className="mobAvatarName">Benjamin Mai</div>
          </div>
          <ul>
